...
import com.example.android.researchhero.fragment.ResearchQuestionQuizFragment;

/**
 * Created by absak on 7/13/2017.
 */

public class ResearchQuestionFragmentPagerAdapter extends FragmentPagerAdapter {
    final int PAGE_COUNT = 2;
    private String tabTitles[] = new String[] { "Lesson 01", "Quiz 01"};
    private Context context;

    public ResearchQuestionFragmentPagerAdapter(FragmentManager fm, Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new ResearchQuestionLessonFragment();
        }
        else {
            return new ResearchQuestionQuizFragment();
        }
    }
