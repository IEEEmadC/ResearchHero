...
public class LearnResearchPurposeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_research_purpose);
        ...
        ResearchPurposeFragmentPagerAdapter adapter = new ResearchPurposeFragmentPagerAdapter(
                getSupportFragmentManager(),
                LearnResearchPurposeActivity.this);
